import { SET_ACCESS_TOKEN, SetAccessTokenAction, UserState } from "./user-type";
...
import { UserModel } from "../../shared/models/onboarding/internal/userModel";

export const initialUserState: UserState = {
  accessToken:
    getValueForKeyInBrowserStorage<string>(BROWSER_STORAGE_KEY_ACCESS_TOKEN) ||
    null,
